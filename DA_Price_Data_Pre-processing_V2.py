...
# load labels
price_data = pd.read_csv('./Data/price/Raw_Data/N2EX_UK_DA_Auction_Hourly_Prices_2019_2021_V2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)
...
test_split_seq = 9600 # use the last 100 days, around 10%
