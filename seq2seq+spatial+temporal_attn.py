...
# declare loss functions for each quantile
...
model.save(f'../../models/{model_type}/{model_type}_main.h5')
...
enoder_temporal_model.save(f'../../models/{model_type}/{model_type}_temporal_enc.h5')

# dave spatail encoders if not price forecasting
if model_type != 'price':
	enoder_spatial_model = Model(x_input, ccn_enc_output)
	enoder_spatial_model.save(f'../../models/{model_type}/{model_type}_spatial_enc.h5')
