...
with open("./Data/solar/Processed_Data/time_refs_V20_withtimefeatures_120hr.pkl", "wb") as times:
	dump(time_refs, times)


# save training set as dictionary (h5py dump)
f = h5py.File('./Data/solar/Processed_Data/train_set_V20_withtimefeatures_120hrinput.hdf5', 'w')
