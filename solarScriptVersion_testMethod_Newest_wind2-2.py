...
for q in quantiles: 
	...
	decoder = LSTM(128, return_sequences = False, return_state = True, name=f'decoder_q_{q}')
	...
	output_2 = Dense(48, name=f'dense3_q_{q}')
	...
	dec_output, s_state, c_state = decoder(lstm_enc_output)
	...
	qunatile_predictions.append(output)
	# K.clear_session()
