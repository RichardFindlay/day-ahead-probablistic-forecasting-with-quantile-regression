...
with open(f'../../results/{model_type}/forecasted_time_series_{model_type}.pkl', 'wb') as ts_file:
	dump(predictions, ts_file)

# save results - forecasted temporal attention matrix
with open(f'../../results/{model_type}/attention_data_{model_type}.pkl', 'wb') as attention_file:
	dump(quantile_temporal_attns, attention_file)

# save results - forecasted spatial attention matrix
with open(f'../../results/{model_type}/attention_data_{model_type}.pkl', 'wb') as spatial_file:
