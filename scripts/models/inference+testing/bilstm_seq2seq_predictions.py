...
f = h5py.File(f"../../../data/processed/{forecast_var}/dataset_{forecast_var}.hdf5", "r")
...
# load scaler 
scaler = load(open(f'../../../data/processed/{forecast_var}/_scaler/scaler_{forecast_var}.pkl', 'rb'))
