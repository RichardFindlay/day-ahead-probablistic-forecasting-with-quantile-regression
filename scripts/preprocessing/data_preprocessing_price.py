...
# load input data
windGen_data = pd.read_csv('../../data/raw/wind_labels/HH_windGen_v2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)
solarGen_data = pd.read_csv('../../data/raw/solar_labels/HH_PVGen_v2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)
demand_data = pd.read_csv('../../data/raw/demand_labels/HH_demand_v2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)

# load labels
price_data = pd.read_csv('../../data/raw/price_labels/N2EX_UK_DA_Auction_Hourly_Prices_v2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)
...
dump(scaler, open('../../data/processed/price/_scaler/scaler_price_v2.pkl', 'wb'))
...
test_split_seq = 8544 # larger test test to compensate adverse demand from COVID
...
# save dataset
with open("../../data/processed/price/time_refs_price_v2.pkl", "wb") as times:
	dump(time_refs, times)

# save training set as dictionary (h5py dump)
f = h5py.File('../../data/processed/price/dataset_price_v2.hdf5', 'w')
