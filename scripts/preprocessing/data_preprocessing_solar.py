...
solarGenLabels = pd.read_csv('../../data/raw/solar_labels/HH_PVGen_v2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)
...
print('saving data...')
with open("../../data/processed/solar/time_refs_solar_min_v4.pkl", "wb") as times:
	dump(time_refs, times)

# save training set as dictionary (h5py dump)
f = h5py.File('../../data/processed/solar/dataset_solar_min_v4.hdf5', 'w')
