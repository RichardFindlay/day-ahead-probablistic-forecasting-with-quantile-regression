...
demandGenLabels = pd.read_csv('../../data/raw/demand_labels/HH_demand_v2.csv', parse_dates=True, index_col=0, header=0, dayfirst=True)
...
print('saving data...')
with open("../../data/processed/demand/time_refs_demand_v4.pkl", "wb") as times:
	dump(time_refs, times)

# save training set as dictionary (h5py dump)
f = h5py.File('../../data/processed/demand/dataset_demand_v4.hdf5', 'w')
