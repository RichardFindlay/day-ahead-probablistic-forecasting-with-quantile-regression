...
for q in quantiles: 
	...
	for ts in range(Ty):
		...
		output = Dense(32, activation="swish", name=f'dense1_q_{q}_{ts}')(prediction)
		...
		output = Dense(1, activation="swish", name=f'dense2_q_{q}_{ts}')(output)
		# output = Activation('swish', name=f'swish_act_q_{q}_{ts}')(output)
...
train = model.fit(training_generator, epochs = 30)
